...
but general-arithmetic and combination proof production, conformance,
fragment-complete validation, and competition-scale performance still separate
it from a general world-class SMT solver.
